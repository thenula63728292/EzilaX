...
PM_START_TEXT = """
👋 𝗛𝗲𝗹𝗹𝗼 𝘁𝗵𝗲𝗿𝗲, 𝗜'𝗺 @Lisa_uwu_robot
𝗜'𝗺 𝗮 𝗣𝗼𝘄𝗲𝗿𝗳𝘂𝗹 𝗴𝗿𝗼𝘂𝗽 𝗺𝗮𝗻𝗮𝗴𝗲𝗿 𝗯𝗼𝘁 𝗪𝗶𝘁𝗵 𝗖𝗼𝗼𝗹 𝗠𝗼𝗱𝘂𝗹𝗲𝘀. 𝗠𝗮𝗱𝗲 𝗯𝘆 ⚡️ @Thenula66
...
buttons = [
    [
        InlineKeyboardButton(
            text="Lisa updates 🙋‍♂️", url="https://t.me/Lisauwurobot"
        ),
        InlineKeyboardButton(
            text="𝚂𝚞𝚙𝚙𝚘𝚛𝚝 𝙶𝚛𝚘𝚞𝚙 💬", url="https://t.me/SDBOTz"
        ),
    ],
    [
        InlineKeyboardButton(
            text="𝚂𝚘𝚞𝚛𝚌𝚎 🗒", url="Github.com/Thenula63728292/EzilaX"
        ),
        InlineKeyboardButton(
            text="𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜 𝙷𝚎𝚕𝚙 ❓", url="http://t.me/Lisa_uwu_robot?start=help"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ 𝙰𝚍𝚍 𝙼𝚎 𝚝𝚘 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙 ➕",
            url="t.me/Lisa_uwu_robot?startgroup=true",
        ),
    ],
]

EZILAX_IMG = "https://telegra.ph/file/9ccd5c6d972de9c2449dd.jpg"
...
Support them  [Thenula svr](t.me/Thenula66)"""
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Thenula SVR.* "
            f"\n\n Join [lisa updates](https://t.me/Lisauwurobot) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Lisa Updates](https://t.me/Lisauwurobot).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Lisa Updates](https://t.me/Lisauwurobot)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by Sadew Jayasekara and Thenula Senevirathna"
